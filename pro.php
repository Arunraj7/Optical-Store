...
<html lang="en">
	...
	//$query= mysqli_query($conn,"SELECT * from user where email='$a';");
	$sql = "SELECT * from user where email='$a';";
	//$cid = mysqli_query($conn,"SELECT cid from user where email='$a'");
	...
	<body>
		...
		<section class="ftco-section">
				...
				<div class="row">
					<?php 
						...
						if ($conn->connect_error) {
						    ...
						    $sql = "SELECT * from product where pid=$aa;";
						    $result = $conn->query($sql);
						    if ($result->num_rows > 0) 
						{
						while($row = $result->fetch_assoc()) 
					...
					<div class="col-lg-6 mb-5 ftco-animate">
						<img src="images/frames/<?php echo $row['pimgid'].".jpg" ?>" class="img-fluid" alt=""></a>
					</div>
					<form method="post">
						<div class="col-lg-6 product-details pl-md-5 ftco-animate">
							...
							<p class="price"><span><?php echo $row['dprice']?></span></p>
								...
								<div class="col-md-6">
									...
									<!-- <div class="w-100"></div>
										<div class="input- group col-md-6 d-flex mb-3">
										        	...
										        	<input type="text"  id="quantity" name="quantity" class="form-control input-number" value="0.25" >
										        	<span class="input-group-btn ml-2">
										           	<button onclick="myFunction()" type="button" class="quantity-right-plus btn" >
									...
									<div>
										<b>LEFT  &nbsp;&nbsp; EYE : &emsp;</b> 
										<input type="number" name="left" min="-10" max="18" step="0.25" />
									</div>
									<br>
									<div>
										<b>RIGHT EYE : &emsp;</b> 
										<input type="number" name="right" min="-10" max="18" step="0.25" />
									</div>
									<!--<div class="w-100"></div>				  
										<div class="col-md-12">
							...
							<br>
							<input type="submit" class="btn btn-black py-3 px-5" name="buy" value="BUY " />

						<!--	<button name="buy" type="button">Click Me!</button>
							<a name="buy" type = "submit" class="btn btn-black py-3 px-5">Buy Now</a>-->
			...
			if(isset($_POST['buy']))
			{
				...
				values ($pidd,'$namee',$price,$left,$right,$cid,$pidd)";
